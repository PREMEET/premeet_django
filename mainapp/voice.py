...
# filler_determine_model = load_model(f'{model_path}filler_determine_model.h5')
# filler_classifier_model = load_model(f'{model_path}filler_classifier_model.h5')
...
# def main(request):
# 	transcript_json, statistics_filler_json, statistics_silence_json = make_transcript("data/wav/apple.mp3")
